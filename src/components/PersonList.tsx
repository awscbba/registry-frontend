...
export default function PersonList({ people, onEdit, onDelete, isLoading = false }: PersonListProps) {
  if (isLoading) {
    return (
    ...
    return (
      <div className="bg-white rounded-lg shadow-md p-6 text-center">
        <div className="text-gray-500">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No people registered</h3>
          <p className="text-gray-500">Get started by registering your first person.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      <div className="px-6 py-4 border-b border-gray-200">
        <h3 className="text-lg font-medium text-gray-900">Registered People ({people.length})</h3>
      </div>
